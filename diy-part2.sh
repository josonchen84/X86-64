...
sed -i 's/"upnp"/"路由器网络端口转发"/g' feeds/luci/applications/luci-app-upnp/po/zh-cn/upnp.po

sed -i 's/"UPnP"/"路由器网络端口转发"/g' feeds/luci/applications/luci-app-upnp/po/zh-cn/upnp.po

sed -i 's/"通用即插即用（UPnP）"/"路由器网络端口转发"/g' feeds/luci/applications/luci-app-upnp/po/zh-cn/upnp.po
